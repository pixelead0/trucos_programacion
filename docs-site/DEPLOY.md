...
1. Repositorio en GitHub: `pixelead0/pyquiles-al-pastor`
...
**https://pixelead0.github.io/pyquiles-al-pastor/**
...
- El `baseUrl` está configurado como `/pyquiles-al-pastor/` en `docusaurus.config.js`
