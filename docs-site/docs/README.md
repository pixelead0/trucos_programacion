...
1. [El Zen de Python](./01_Introduccion_y_Fundamentos/00_zen_of_python.md) - Filosofía del lenguaje
2. [Variables y Tipos](./01_Introduccion_y_Fundamentos/01_variables_y_tipos.md) - Fundamentos básicos
...
1. [Pathlib](./06_Manejo_de_Archivos_y_Formatos/01_pathlib.md)
2. [XML](./06_Manejo_de_Archivos_y_Formatos/02_xml.md)
3. [JSON](./06_Manejo_de_Archivos_y_Formatos/03_json.md)
...
- **Generador de Contraseñas** - Tu primer proyecto útil (ver carpeta `Proyectos_y_Ejercicios/generador_password`)
- **Validador de Datos** - Proyecto evolutivo con 9 versiones (ver carpeta `Proyectos_y_Ejercicios/validador_datos`)
- **Cálculo de Fechas Relativas** - Trabajo con fechas y archivos (ver carpeta `Proyectos_y_Ejercicios/fechas_relativas`)
- **Ejercicios de Validación IP** - Validación y expresiones regulares (ver `Proyectos_y_Ejercicios/validacion_ip.md` en el repositorio)
...
### Fundamentos
- [ ] Completé [El Zen de Python](./01_Introduccion_y_Fundamentos/00_zen_of_python.md)
...
1. [El Zen de Python](./01_Introduccion_y_Fundamentos/00_zen_of_python.md)
